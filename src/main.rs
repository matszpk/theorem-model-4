...
fn main() {
    ...
    pm.circuit.extend([
        ...
        // machine.put_nand(t9 [0], a1 [9], t6 [0]);
        9, 0, 0xff,
        // t6 [1], t7 [2], t3 [3], t4 [4], t5 [5], t0 [6], t1 [7], t2 [8],
        // a0 [9], a1 [10], a2 [11]
        // machine.put_nand(t8 [0], t2 [8], t6 [1]);
        // machine.put_nand(t10 [1], t2 [8], t7 [2]);
        8, 1, 8, 2, 0xff,
        // t9 [2], t6 [3], t7 [4], t3 [5], t4 [6], t5 [7], t0 [8], t1 [9], t2 [10],
        // a0 [11], a1 [12], a2 [13]
        // machine.put_nand(r0 [0], t9 [2], t10 [1]);
        // t8 [1], t10 [2] t8 [3], t9 [4], t6 [5], t7 [6], t3 [7], t4 [8], t5 [9], t0 [10],
        // t1 [11], t2 [12], a0 [13], a1 [14], a2 [15]
        2, 1,
    ]);
    for i in 0..8 {
        println!("-------------");
